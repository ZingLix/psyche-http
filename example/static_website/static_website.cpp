...
int main(int argc, char* argv[]) {
    ...
    server.set_recv_callback([&](HttpRequest& recvmsg, HttpResponse& sendmsg)
    {
        std::string path = recvmsg.get_path();
